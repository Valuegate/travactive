  ...
  return (
    <Router>
      <Routes>
        ...
        {/* ===== ONBOARDING & AUTH (NO FOOTER) ===== */}
        <Route
          path="/get-started"
          element={<Layout hideFooter><GetStarted /></Layout>}
        />
        ...
        <Route
          path="/top-picks"
          element={<Layout hideFooter><TopPicks /></Layout>}
        />
        <Route
          path="/dashboard/overview"
          element={<Layout hideFooter><Overview /></Layout>}
        />
        <Route
          path="/dashboard"
