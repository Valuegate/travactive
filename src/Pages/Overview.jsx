...
const HeroBanner = () => (
  <div className="relative w-full h-48 rounded-3xl overflow-hidden flex items-center">
    <img src={heroImg} alt="Hero" className="absolute inset-0 w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
  </div>
);
...
const RecommendCard = ({ img, title, desc, status }) => (
  <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
    ...
    <button className="w-full py-2.5 border border-teal-900 text-xs font-bold rounded-xl hover:bg-teal-900 hover:text-white transition-colors duration-200">
      Explore
    </button>
  </div>
);
...
const News = ({ flag, title, source }) => (
  <div className="flex gap-3 pb-3 border-b border-gray-100 last:border-0 group hover:bg-gray-50 -mx-2 px-2 py-1 rounded-lg transition-colors duration-200 cursor-pointer">
    ...
    <div className="flex-1 min-w-0">
      <h5 className="text-sm font-bold leading-snug mb-1 truncate group-hover:text-teal-900 transition-colors duration-200">{title}</h5>
      <p className="text-[11px] text-gray-500">Source: <span className="text-blue-600 hover:underline hover:text-blue-800 transition-colors duration-200">{source}</span></p>
    </div>
  </div>
);
