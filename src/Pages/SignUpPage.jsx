...
const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/overview"); // Directs user to the Dashboard
  };
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-4 py-3 rounded-full bg-gray-100 text-gray-600 focus:outline-none focus:ring-1 focus:ring-emerald-700"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full mt-1 px-4 py-3 rounded-full bg-gray-100 focus:outline-none focus:ring-1 focus:ring-emerald-700 pr-10"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-2 text-sm">
              <input type="checkbox" className="accent-emerald-700" required />
              <span className="text-gray-600">I agree to the Terms and conditions</span>
            </div>

            {/* Submit */}
            <button 
              type="submit"  // This is already correct
              className="w-full bg-emerald-900 hover:bg-emerald-950 text-white rounded-full py-3 font-medium transition shadow-md"
            >
              Register Now
            </button>
          </form>
